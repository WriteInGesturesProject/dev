...
public class GodotSpeech extends Godot.SingletonBase implements RecognitionListener {
                ...
                m_pActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                                try {
                                        ...
                                        Log.i(LOG_TAB, "godot exception " + e.getMessage());
                                }
                        }
                });
        }
        ...
        public GodotSpeech(Activity p_activity) {
                ...
                registerClass("GodotSpeech", new String[] { "doListen", "getWords", "isDetectDone", "isError",
                                "resetDetectionFlag", "resetErrorFlag", "getErrorState", "isListening", "stopListen" });
        }
        ...
        public void onBeginningOfSpeech() {
                Log.i(LOG_TAB, "onBeginningOfSpeech");
        }

        public void onBufferReceived(byte[] buffer) {
                Log.i(LOG_TAB, "onBufferReceived");
        }

        public void onEndOfSpeech() {
                Log.i(LOG_TAB, "onEndOfSpeech");
        }
        ...
        public void onEvent(int eventType, Bundle params) {
                Log.i(LOG_TAB, "onEvent");
        }

        public void onPartialResults(Bundle partialResults) {
                Log.i(LOG_TAB, "onPartialResults");
        }
