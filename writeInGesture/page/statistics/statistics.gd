...
func displayStatisticsWordsEasierHarder(nbMin : int):
	...
	titleHarder.set("custom_colors/font_color", Color(1,1,1))
	titleHarder.text = "Les mots les moins réussi :"
	nodeRootHarder.add_child(titleHarder)
	
	var titleEasier = Label.new()
	titleEasier.set("custom_colors/font_color", Color(1,1,1))
...
func displayStatisticsAllWords():
	...
	title.set("custom_colors/font_color", Color(1,1,1))
...
func _on_back_pressed():
	get_tree().change_scene("res://page/navigation/speechTherapistMenu.tscn")
