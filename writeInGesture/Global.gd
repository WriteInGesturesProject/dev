...
func loadEntity():
	...
	ManageJson.getElement("exercice.json", "Exercice", customExercice)
	customExercice.setAttribut("nameFile", "exercice.json")
	
	ManageJson.getElement("wordsAvailable.json", "WordsAvailable", wordsAvailable)
	player.setAttribut("nameFile", "wordsAvailable.json")
	
	ManageJson.getElement("dictionnary.json", "Dictionnary", wordDictionnary)
	player.setAttribut("nameFile", "dictionnary.json")
